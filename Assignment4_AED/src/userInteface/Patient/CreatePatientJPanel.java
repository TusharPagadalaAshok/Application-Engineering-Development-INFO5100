...
public class CreatePatientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(primaryDocNameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 150, 150, -1));
        add(prefferedPharmacyJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, 150, -1));

        addPatientJButton.setBackground(new java.awt.Color(255, 255, 204));
        addPatientJButton.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        add(addPatientJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 100, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1000, 40));

        patientIDJLabel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        patientIDJLabel.setText("Patient ID:");
        add(patientIDJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, -1, -1));

        primaryDocNameJLabel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        primaryDocNameJLabel.setText("Physician Name:");
        add(primaryDocNameJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, -1, -1));

        prefferedPharmacyJLabel.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        prefferedPharmacyJLabel.setText("Medical Department:");
        add(prefferedPharmacyJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 180, -1, -1));
        add(patientIDJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 120, 150, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 100, -1));
